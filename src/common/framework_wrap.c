...
{/*
  ...
  unsigned long userData = (unsigned long)lua_touserdata(L,1);
  lua_getmetatable(L,1);   
  assert(lua_istable(L,-1)); 
...
static swig_lua_class _wrap_class_Camera = { "Camera", &SWIGTYPE_p_Camera,_wrap_new_Camera, swig_delete_Camera, swig_Camera_methods, swig_Camera_attributes, { "Camera", swig_Camera_cls_methods, swig_Camera_cls_attributes, swig_Camera_cls_constants }, swig_Camera_bases, swig_Camera_base_names };
...
static swig_lua_attribute swig_Rect_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Rect_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_Rect_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_Rect_bases[] = {0};
static const char *swig_Rect_base_names[] = {0};
static swig_lua_class _wrap_class_Rect = { "Rect", &SWIGTYPE_p_Rect,_wrap_new_Rect, swig_delete_Rect, swig_Rect_methods, swig_Rect_attributes, { "Rect", swig_Rect_cls_methods, swig_Rect_cls_attributes, swig_Rect_cls_constants }, swig_Rect_bases, swig_Rect_base_names };
...
static swig_lua_attribute swig_RawBitmapData_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_RawBitmapData_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_RawBitmapData_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_RawBitmapData_bases[] = {0};
static const char *swig_RawBitmapData_base_names[] = {0};
static swig_lua_class _wrap_class_RawBitmapData = { "RawBitmapData", &SWIGTYPE_p_RawBitmapData,_wrap_new_RawBitmapData, swig_delete_RawBitmapData, swig_RawBitmapData_methods, swig_RawBitmapData_attributes, { "RawBitmapData", swig_RawBitmapData_cls_methods, swig_RawBitmapData_cls_attributes, swig_RawBitmapData_cls_constants }, swig_RawBitmapData_bases, swig_RawBitmapData_base_names };
...
static swig_lua_attribute swig_BitmapData_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_BitmapData_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_BitmapData_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_BitmapData_bases[] = {0};
static const char *swig_BitmapData_base_names[] = {0};
static swig_lua_class _wrap_class_BitmapData = { "BitmapData", &SWIGTYPE_p_BitmapData,_wrap_new_BitmapData, swig_delete_BitmapData, swig_BitmapData_methods, swig_BitmapData_attributes, { "BitmapData", swig_BitmapData_cls_methods, swig_BitmapData_cls_attributes, swig_BitmapData_cls_constants }, swig_BitmapData_bases, swig_BitmapData_base_names };
...
static swig_lua_attribute swig_Texture_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Texture_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_Texture_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_Texture_bases[] = {0};
static const char *swig_Texture_base_names[] = {0};
static swig_lua_class _wrap_class_Texture = { "Texture", &SWIGTYPE_p_Texture,_wrap_new_Texture, swig_delete_Texture, swig_Texture_methods, swig_Texture_attributes, { "Texture", swig_Texture_cls_methods, swig_Texture_cls_attributes, swig_Texture_cls_constants }, swig_Texture_bases, swig_Texture_base_names };
