...
static int _wrap_Camera_posX_set(lua_State* L) {
  ...
  SWIG_check_num_args("posX",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("posX",1,"Camera *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("posX",2,"float");
...
static int _wrap_Camera_posY_set(lua_State* L) {
  ...
  SWIG_check_num_args("posY",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("posY",1,"Camera *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("posY",2,"float");
...
static int _wrap_Camera_width_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("width",1,"Camera *");
...
static int _wrap_Camera_height_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("height",1,"Camera *");
...
static int _wrap_Camera_Foo(lua_State* L) {
  ...
  SWIG_check_num_args("Camera_Foo",0,0)
  Camera_Foo();
...
static int _wrap_new_Camera(lua_State* L) {
  ...
  result = (Camera *)calloc(1, sizeof(Camera));
...
static swig_lua_class _wrap_class_Camera = { "Camera", &SWIGTYPE_p_Camera,_wrap_new_Camera, swig_delete_Camera, swig_Camera_methods, swig_Camera_attributes, swig_Camera_bases, swig_Camera_base_names };
...
static int _wrap_Rect_x_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("x",1,"Rect *");
...
static int _wrap_Rect_y_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("y",1,"Rect *");
...
static int _wrap_Rect_w_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("w",1,"Rect *");
...
static int _wrap_Rect_h_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("h",1,"Rect *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("h",2,"float");
...
static swig_lua_class _wrap_class_Rect = { "Rect", &SWIGTYPE_p_Rect,_wrap_new_Rect, swig_delete_Rect, swig_Rect_methods, swig_Rect_attributes, swig_Rect_bases, swig_Rect_base_names };
...
static int _wrap_RawBitmapData_data_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("data",1,"RawBitmapData *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("data",2,"unsigned char *");
...
static int _wrap_RawBitmapData_width_set(lua_State* L) {
  ...
  SWIG_check_num_args("width",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("width",1,"RawBitmapData *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("width",2,"unsigned int");
...
static int _wrap_RawBitmapData_height_set(lua_State* L) {
  ...
  SWIG_check_num_args("height",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("height",1,"RawBitmapData *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("height",2,"unsigned int");
...
static int _wrap_new_RawBitmapData(lua_State* L) {
  ...
  result = (RawBitmapData *)calloc(1, sizeof(RawBitmapData));
...
RawBitmapData *arg1 = (RawBitmapData *) obj;
free((char *) arg1);
}
...
static swig_lua_class _wrap_class_RawBitmapData = { "RawBitmapData", &SWIGTYPE_p_RawBitmapData,_wrap_new_RawBitmapData, swig_delete_RawBitmapData, swig_RawBitmapData_methods, swig_RawBitmapData_attributes, swig_RawBitmapData_bases, swig_RawBitmapData_base_names };
...
static int _wrap_BitmapData_width_set(lua_State* L) {
  ...
  SWIG_check_num_args("width",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("width",1,"BitmapData *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("width",2,"int");
...
static int _wrap_BitmapData_height_set(lua_State* L) {
  ...
  SWIG_check_num_args("height",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("height",1,"BitmapData *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("height",2,"int");
...
static int _wrap_BitmapData_glTexHandle_set(lua_State* L) {
  ...
  SWIG_check_num_args("glTexHandle",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("glTexHandle",1,"BitmapData *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("glTexHandle",2,"GLuint");
...
static int _wrap_BitmapData_glTexHandle_get(lua_State* L) {
  ...
  SWIG_check_num_args("glTexHandle",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("glTexHandle",1,"BitmapData *");
...
static int _wrap_new_BitmapData(lua_State* L) {
  ...
  result = (BitmapData *)calloc(1, sizeof(BitmapData));
...
BitmapData *arg1 = (BitmapData *) obj;
free((char *) arg1);
}
...
static swig_lua_class _wrap_class_BitmapData = { "BitmapData", &SWIGTYPE_p_BitmapData,_wrap_new_BitmapData, swig_delete_BitmapData, swig_BitmapData_methods, swig_BitmapData_attributes, swig_BitmapData_bases, swig_BitmapData_base_names };
...
static int _wrap_Texture_width_set(lua_State* L) {
  ...
  SWIG_check_num_args("width",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("width",1,"Texture *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("width",2,"int");
...
static int _wrap_Texture_height_set(lua_State* L) {
  ...
  SWIG_check_num_args("height",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("height",1,"Texture *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("height",2,"int");
...
static int _wrap_Texture_uvCoords_set(lua_State* L) {
  ...
  SWIG_check_num_args("uvCoords",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("uvCoords",1,"Texture *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("uvCoords",2,"GLfloat [12]");
...
static int _wrap_Texture_uvCoords_get(lua_State* L) {
  ...
  SWIG_check_num_args("uvCoords",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("uvCoords",1,"Texture *");
...
static int _wrap_Texture_data_set(lua_State* L) {
  ...
  SWIG_check_num_args("data",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("data",1,"Texture *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("data",2,"BitmapData *");
...
static swig_lua_class _wrap_class_Texture = { "Texture", &SWIGTYPE_p_Texture,_wrap_new_Texture, swig_delete_Texture, swig_Texture_methods, swig_Texture_attributes, swig_Texture_bases, swig_Texture_base_names };
...
static int _wrap_streamingAudioLoad(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("streamingAudioLoad",1,"char const *");
...
static int _wrap_loadAscii(lua_State* L) {
  int SWIG_arg = 0;
  char *arg1 = (char *) 0 ;
  int *arg2 = (int *) 0 ;
  char *result = 0 ;
  
  SWIG_check_num_args("loadAscii",2,2)
  if(!lua_isstring(L,1)) SWIG_fail_arg("loadAscii",1,"char const *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("loadAscii",2,"int *");
  arg1 = (char *)lua_tostring(L, 1);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("loadAscii",2,SWIGTYPE_p_int);
  }
  
  result = (char *)loadAscii((char const *)arg1,arg2);
...
static int _wrap_loadImage(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("loadImage",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
